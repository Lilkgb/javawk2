export default class Doctor {
  getDoctor(docName,city,state) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?name=${docName}&location=${state}-${city}&user_location=37.773%2C-122.413&skip=0&limit=10&user_key=1444ae1df809a2c84653c5b90a9e9726`;
